...
class TestBlobEmulatorBasicOperations:
    ...
    def test_upload_and_download_blob(
        self, azurite_blob_service, azurite_test_container
    ):
...
class TestBlobEmulatorExistenceAndDeletion:
    ...
    def test_delete_nonexistent_blob(
        ...
        azurite_blob_service.delete_blob(
            azurite_test_container,
            f"nonexistent-{uuid4().hex}.txt"
        )
...
class TestBlobEmulatorURLParsing:
    ...
    def test_parse_emulator_url_with_spaces(
        self, azurite_blob_service, azurite_test_container
    ):
